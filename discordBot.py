...
async def on_ready():
        ...
        print('current time = ' + (datetime.now()+ timedelta(hours=3)).strftime("%d/%m/%Y %H:%M:%S"))
...
async def change_status():
	...
	await bot.change_presence(activity=discord.Game(name="#theory"))
